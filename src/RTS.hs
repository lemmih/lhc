...
linkRTS target = do
  ...
  cached <- getDataFileName "rts/gc/cached.c"
  ...
  assertProcess link [target, semi_dst, cached_dst, api_dst, stats_dst, "-S", "-o", target]
